...
import com.lin.common.utils.SendEmailUtil;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    @NotNull
    public Result Login(@NotNull String username, @NotNull String password, @NotNull String code, String codeDate){
        if(username.equals("")){
        ...
        String codeRedis = (String) redisTemplate.opsForValue().get(RedisStatus.USER_CODE + codeDate);
        //获取当前登录对象
        User user = null;
    ...
    public List<User> getListUserByUsernameOrNickname(String usernameOrNickname) {
        List<User> users = userMapper.selectListUserByUsernameOrNickname(usernameOrNickname);
        return users;
    }
}
